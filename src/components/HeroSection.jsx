  ...
  return (
    <div id="home" className="flex flex-col mt-6 lg:mt-20 items-center">
      ...
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        ...
        <span>
          {" "}
          THUB helps developers and creators build real-world tech skills
          through hands-on projects, expert mentorship, and a vibrant community.
          Join us and turn your ideas into reality.
        </span>
      </p>
      <div className="flex justify-center my-10">
        <a
          href="https://docs.google.com/forms/d/e/1FAIpQLScM9hGkXRE4Q4H1hxcRfJyStnvBk7MiuXYAL0SjP5kiWILhRA/viewform?usp=publish-editor"
